...
public class FormInstructionConfig {
	...
	// 填表说明配置
	public static final String FORM_INSTRUCTION_YOUNG_FARMER = "1.现代青年农场主创业资助登记表由有意愿参加新型职业农民创业资助项目的个人按实际情况填写。<br>"
	...
	public static final String FORM_INSTRUCTION_PRODUCT_FARMER = "1.生产经营型职业农民创业资助登记表由有意愿参加生产经营型职业农民创业资助项目的个人按实际情况填写。<br>"
			+ "2.中专、大专、大学及以上文化程度请填写专业。<br>" + "3. 获取证书情况可多选。<br>" + "4.专业学习培训经历可在空白处添加相关内容，字数不超过300字。<br>"
			+ "5.主体产业可选择1-3项填写，产业规模和年限对应所选主体产业分别填写。<br>" + "6.上年度产业收入和上年度家庭收入，初次填写为认定年度上一年的收入，之后填写为审核年度上一年的收入。";
	public static final String FORM_INSTRUCTION_TECHNICAL_FARMER = "1. 专业技能型、专业服务型职业农民创业资助登记表由有意愿参加新型职业农民创业资助项目的个人按实际情况填写。<br>"
	...
	public static final String FORM_INSTRUCTION_LEADER_FARMER = "1.新型农业经营主体带头人创业资助登记表由有意愿参加新型职业农民创业资助项目的个人按实际情况填写。<br>"
			+ "2. 中专、大专、大学及以上文化程度请填写专业。<br>" + "3. 获取证书情况可多选。<br>" + "4. 专业学习培训经历可在空白处添加相关内容，字数不超过300字。<br>"
			+ "5. 主体产业可选择1-3项填写，产业规模和年限对应所选主体产业分别填写。<br>" + "6. 上年度产业收入和上年度家庭收入，初次填写为认定年度上一年的收入，之后填写为审核年度上一年的收入。";
