...
public class DeclareInfoDao {
	...
	public int insertDeclareInfo(DeclareInfoBean bean) {
		...
		try {
			...
			String sql = "insert into declare_info ( user_id, declare_type, declare_year, declare_category, declare_status, auth_organization_id, auth_status, status, create_time, create_user, memo) value( ?, ?, ?, ?, ?, ?, ?, ?, now(), ?, ?)";
