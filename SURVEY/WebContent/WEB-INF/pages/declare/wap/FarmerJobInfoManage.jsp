    	...
    	<section class="info-table">
    	 <ul class="form-s1">
            ...
            <li>
                ...
                <dt><input maxlength="5" placeholder="请输入数字" type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " name="experience" id="experience" value="<%=bean.getExperience() >0 ? bean.getExperience() : ""%>" size="5" maxlength="5"></dt>
            </li>
