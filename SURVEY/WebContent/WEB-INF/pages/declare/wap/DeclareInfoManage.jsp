...
<body class="article_bg">
	...
	<div class="declare-box g-mt10">
		<p>
			...
			<%if(declareType==DeclareInfoConfig.DECLARE_TYPE_LEADER_FARMER&&entry.getKey().equals(DeclareInfoConfig.MODULE_FARMER_INDUSTRY_INFO)){ %>
			<%="经营/服务情况" %>
			<%}else{ %>
			<%=DeclareInfoConfig.DECLARE_MODULE_MAP.get(entry.getKey()) %>
			<%} %>
