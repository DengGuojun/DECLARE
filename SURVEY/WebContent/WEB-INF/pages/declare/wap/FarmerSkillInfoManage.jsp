...
<div class="g-pb65 hide-1 fixed no-auto"  id="layer-time" >
    ...
    <ul class="form-s1">
        <li>
            <dd>日期:</dd>
            <input type="text"  id="certificationDate" name="certificationDate" data-verify="birthday" value="<%=bean.getCertificationDate()==null? "":DateKit.formatTimestamp(bean.getCertificationDate(), DateKit.DEFAULT_DATE_FORMAT) %>" autocomplete="off">
        </li>
    </ul>
</div>
...
<script>
$(function () {
    $('#certificationDate').mobiscroll().date({
        theme: 'default',
        mode: 'scroller',
        display: 'bottom',
        lang: 'zh',
