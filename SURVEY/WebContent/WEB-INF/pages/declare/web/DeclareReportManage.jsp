...
<% 
	...
	int declareId = (int)request.getAttribute("declareId");
	String jobType = (String)request.getAttribute("JobType");
	String jobName = (String)request.getAttribute("JobName");
	String industryJobType = (String)request.getAttribute("IndustryJobType");
	String industryJobName = (String)request.getAttribute("IndustryJobName");
...
<body class="article_bg">
	<div class="article_tit">
		...
		<ul class="art_nav">
			<li><a href="DeclareReportList.do">资助项目申请信息列表</a>&nbsp;>&nbsp;</li>			
