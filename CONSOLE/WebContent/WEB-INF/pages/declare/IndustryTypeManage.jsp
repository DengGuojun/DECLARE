...
<% 
    IndustryTypeBean bean = (IndustryTypeBean)request.getAttribute("IndustryTypeBean");
...
<body class="article_bg">
    <div class="article_tit">
		...
		<ul class="art_nav">
			<li><a href="IndustryTypeList.do">产业类型列表</a>&nbsp;>&nbsp;</li>
			<% if(typeId > 0) {%>
    ...
    <form id="formData" name="formData" method="post" action="IndustryTypeManage.do" onsubmit="javascript:return checkForm('formData');">
	  <input type="hidden" name="typeId" id="typeId" value="<%=typeId %>"/>
	  <div class="modify_form">
	    <p>
	      <em class="int_label"><span>*</span>产业类型名称：</em>
	      <input type="text" name="typeName" id="typeName" size="20" maxlength="50" value="<%=bean.getTypeName() %>" checkStr="产业类型名称;txt;true;;50"/>
	    </p>	    
	    <p>
