...
<div class="search_form">
  ...
  <table width="100%" border="0"  cellpadding="0" class="table_style">
    ...
    <tr>
      ...
      <td align="center">
      	<a href="/declare/IndustryInfoManage.do?industryId=<%=bean.getIndustryId()%>&readOnly=true">查看</a> 
      	<%if(adminUserHelper.hasPermission(DeclareInfoResource.DECLARE_INFO, OperationConfig.UPDATE)){ %>
       |<a href="/declare/IndustryInfoManage.do?industryId=<%=bean.getIndustryId()%>&readOnly=false">修改</a>
       <%} %>
      </td>
    </tr>	
    <%} %>
