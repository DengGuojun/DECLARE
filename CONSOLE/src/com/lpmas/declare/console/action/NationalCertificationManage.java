...
@WebServlet("/declare/NationalCertificationManage.do")
public class NationalCertificationManage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = this.getServletContext()
				.getRequestDispatcher(DeclareConsoleConfig.PAGE_PATH + "NationalCertificationManage.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (result > 0) {
				HttpResponseKit.alertMessage(response, "处理成功", "/declare/NationalCertificationList.do");
			} else {
