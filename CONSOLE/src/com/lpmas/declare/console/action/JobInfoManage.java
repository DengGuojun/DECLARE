...
@WebServlet("/declare/JobInfoManage.do")
public class JobInfoManage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = this.getServletContext()
				.getRequestDispatcher(DeclareConsoleConfig.PAGE_PATH + "JobInfoManage.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (result > 0) {
				HttpResponseKit.alertMessage(response, "处理成功", "/declare/JobInfoList.do");
			} else {
