...
import com.lpmas.declare.admin.dao.IdentifiedStatisticsDao;
...
public class IdentifiedStatisticsBusiness {
	...
	public IdentifiedStatisticsBusiness() {
	...
	public void initIdentifiedStatistics(List<Integer> yearList) throws Exception {
		...
		for (int year : yearList) {
			...
			for (ProvinceInfoBean provinceBean : provinceList) {
				IdentifiedStatisticsBean totalProvinceCountBean = new IdentifiedStatisticsBean();
				IdentifiedStatisticsBean targetStatisticsBean = new IdentifiedStatisticsBean();
				...
				targetStatisticsBean = countIdentifiedStatisticsBean(targetStatisticsBean);
				totalProvinceCountBean = countIdentifiedStatisticsBean(totalProvinceCountBean, targetStatisticsBean);

				IdentifiedStatisticsBean orignialBean = getIdentifiedStatisticsByKey(
				...
				if (orignialBean != null) {
					...
					updateIdentifiedStatistics(targetStatisticsBean);
				} else {
					insertIdentifiedStaticsBean(targetStatisticsBean);
				}
				...
				for (CityInfoBean cityBean : cityList) {
					IdentifiedStatisticsBean totalCityCountBean = new IdentifiedStatisticsBean();
					targetStatisticsBean = new IdentifiedStatisticsBean();
					targetStatisticsBean.setDeclareYear(String.valueOf(year));
					...
					targetStatisticsBean = countIdentifiedStatisticsBean(targetStatisticsBean);
					totalCityCountBean = countIdentifiedStatisticsBean(totalCityCountBean, targetStatisticsBean);
					totalProvinceCountBean = countIdentifiedStatisticsBean(totalProvinceCountBean,
							targetStatisticsBean);

					orignialBean = getIdentifiedStatisticsByKey(DeclareAdminConfig.ADMIN_LEVEL_CITY,
					...
					for (RegionInfoBean regionBean : regionList) {
						...
						orignialBean = getIdentifiedStatisticsByKey(DeclareAdminConfig.ADMIN_LEVEL_REGION,
								targetStatisticsBean.getProvince(), targetStatisticsBean.getCity(),
					...
					orignialBean = getIdentifiedStatisticsByKey(DeclareAdminConfig.ADMIN_LEVEL_CITY,
							totalCityCountBean.getProvince(), totalCityCountBean.getCity(), "", String.valueOf(year),
							true);
					if (orignialBean != null) {
						// 更新
						totalCityCountBean.set_id(orignialBean.get_id());
						updateIdentifiedStatistics(totalCityCountBean);
					} else {
						insertIdentifiedStaticsBean(totalCityCountBean);
					}
				...
				orignialBean = getIdentifiedStatisticsByKey(DeclareAdminConfig.ADMIN_LEVEL_PROVINCE,
						totalProvinceCountBean.getProvince(), "", "", String.valueOf(year), true);
				if (orignialBean != null) {
					// 更新
					totalProvinceCountBean.set_id(orignialBean.get_id());
					updateIdentifiedStatistics(totalProvinceCountBean);
				} else {
					insertIdentifiedStaticsBean(totalProvinceCountBean);
				}
			}
		}
	}

	public int insertIdentifiedStaticsBean(IdentifiedStatisticsBean bean) throws Exception {
		IdentifiedStatisticsDao dao = new IdentifiedStatisticsDao();
		return dao.insertIdentifiedStatistics(bean);
	}

	public long updateIdentifiedStatistics(IdentifiedStatisticsBean bean) throws Exception {
		IdentifiedStatisticsDao dao = new IdentifiedStatisticsDao();
		return dao.updateIdentifiedStatistics(bean);
	}

	public IdentifiedStatisticsBean getIdentifiedStatisticsByKey(String id) throws Exception {
		IdentifiedStatisticsDao dao = new IdentifiedStatisticsDao();
		return dao.getIdentifiedStatisticsByKey(id);
	}

	public IdentifiedStatisticsBean getIdentifiedStatisticsByKey(String level, String province, String city,
			String region, String declareYear, boolean sum) throws Exception {
		IdentifiedStatisticsDao dao = new IdentifiedStatisticsDao();
		return dao.getIdentifiedStatisticsByKey(level, province, city, region, declareYear, sum);
	}

	public List<IdentifiedStatisticsBean> getIdentifiedStatisticsListByMap(HashMap<String, String> condMap) {
		HashMap<String, Object> queryMap = new HashMap<String, Object>();
		IdentifiedStatisticsDao declareStatisticsDao = new IdentifiedStatisticsDao();
		...
		List<IdentifiedStatisticsBean> list = null;
		try {
			list = declareStatisticsDao.getIdentifiedStatisticsListByMap(queryMap);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return list;
	...
	public PageResultBean<IdentifiedStatisticsBean> getIdentifiedStatisticsPageListByMap(
		...
		return dao.getIdentifiedStatisticsPageListByMap(queryMap, pageBean);
	}
	...
	public List<IdentifiedStatisticsBean> getIdentifiedStatisticsListByMap(HashMap<String, String> condMap,
		...
		return dao.getIdentifiedStatisticsListByMap(queryMap);
	}
	 ...
	 * @return
	 */
	private IdentifiedStatisticsBean countIdentifiedStatisticsBean(IdentifiedStatisticsBean bean) {
	 ...
	 * @return
	 */
	public IdentifiedStatisticsBean countIdentifiedStatisticsBean(IdentifiedStatisticsBean originalBean,
			IdentifiedStatisticsBean bean) {

		originalBean.setCount(bean.getCount() + originalBean.getCount());
