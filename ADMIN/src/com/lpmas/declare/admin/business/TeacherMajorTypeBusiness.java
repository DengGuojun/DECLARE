...
import com.lpmas.declare.admin.dao.TeacherMajorTypeDao;
...
public class TeacherMajorTypeBusiness {
	public int addMajorType(TeacherMajorTypeBean bean) {
		TeacherMajorTypeDao dao = new TeacherMajorTypeDao();
		return dao.insertTeacherMajorType(bean);
	}

	public int updateMajorType(TeacherMajorTypeBean bean) {
		TeacherMajorTypeDao dao = new TeacherMajorTypeDao();
		return dao.updateTeacherMajorType(bean);
	}

	public TeacherMajorTypeBean getMajorTypeByKey(int majorId) {
		TeacherMajorTypeDao dao = new TeacherMajorTypeDao();
		return dao.getTeacherMajorTypeByKey(majorId);
	}

	public PageResultBean<TeacherMajorTypeBean> getMajorTypePageListByMap(HashMap<String, String> condMap, PageBean pageBean) {
		TeacherMajorTypeDao dao = new TeacherMajorTypeDao();
		return dao.getTeacherMajorTypePageListByMap(condMap, pageBean);
	}

	public ReturnMessageBean verifyMajorType(TeacherMajorTypeBean bean) {
		...
		if (!StringKit.isValid(bean.getMajorName())) {
			...
			List<TeacherMajorInfoBean> majorInfoList = teacherMajorInfoBusiness.getMajorInfoListByTypeId(bean.getMajorId());
	...
	public List<TeacherMajorTypeBean> getTeacherMajorTypeRepeatList() {
		TeacherMajorTypeDao dao = new TeacherMajorTypeDao();
		return dao.getTeacherMajorTypeRepeatList();
	}

	public int deleteMajorType(int majorId) {
		TeacherMajorTypeDao dao = new TeacherMajorTypeDao();
		return dao.deleteTeacherMajorType(majorId);
	}
}