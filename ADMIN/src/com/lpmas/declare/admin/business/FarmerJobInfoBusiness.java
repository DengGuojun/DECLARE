...
import com.lpmas.declare.admin.dao.FarmerJobInfoDao;
...
public class FarmerJobInfoBusiness {
	...
	public int addFarmerJobInfoWithCreateTime(FarmerJobInfoBean bean) {
		FarmerJobInfoDao dao = new FarmerJobInfoDao();
		return dao.insertFarmerJobInfoWtihCreateTime(bean);
	}
