...
public class FarmerIndustryInfoDao {
	...
	public int insertFarmerIndustryInfoWithCreateTime(FarmerIndustryInfoBean bean) {
		int result = -1;
		DBFactory dbFactory = new DeclareDBFactory();
		DBObject db = null;
		try {
			...
			ps.setDouble(37, bean.getLastYearFamilyIncome());
			ps.setInt(38, bean.getStatus());
			ps.setTimestamp(39, bean.getCreateTime());
			ps.setInt(40, bean.getCreateUser());
			ps.setString(41, bean.getMemo());
