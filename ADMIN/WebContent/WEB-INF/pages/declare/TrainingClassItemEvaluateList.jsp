...
<%
	...
	List<TrainingClassItemEvaluateBean> list = (List<TrainingClassItemEvaluateBean>)request.getAttribute("TrainingClassItemEvaluateList");
    ...
    TrainingClassItemBean trainingClassItemBean = (TrainingClassItemBean)request.getAttribute("TrainingClassItemBean");
%>
                            ...
                            <div class="detail_right">
                                <div class="content_wrap">
                                    <div class="detail_right_title h1 white">
                                        <span id="ctl00_ContentPlaceHolder1_Label1" style="float: left;"><%=trainingClassInfoBean.getClassName()%> <%=trainingClassItemBean.getItemName()%>  考核评教</span>
                                    </div>
                                        ...
                                        <div>
                                            <table class="gv js-gvHead" cellspacing="0" rules="all" border="1" style="border-collapse:collapse;">
                                                <tbody>
												    ...
												    <tr>
												    	  <td><%=trainingClassItemBean.getItemName()%></td>
