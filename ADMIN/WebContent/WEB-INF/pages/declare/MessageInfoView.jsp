                            ...
                            <div class="detail_right">
                            	<div class="content_wrap fixed_height">
                            		<div class="detail_right_title h1 white">
                            			<span style="float: left;">查看邮件</span>
                            		</div>
                            		<div class="right_bg" style="padding-left: 5px;">
                            			<div class="mail_head">
                            				...
                            				<div class="mail_info">
                            					<p>发件人：<%=senderName %></p>
                            					<p>收件人：<%=bean.getReceiverList() %></p>
                            					<p>发送时间：<%=DateKit.formatTimestamp(bean.getCreateTime(), DateKit.DEFAULT_DATE_TIME_FORMAT) %></p>
                            				</div>
                            			</div>
                                        <div id="messageContent" class="notice_section notice_section_extra">
                                        	<p><%=bean.getContent() %></p>
                                        </div>
...
$(document).ready(function() {
	$('#messageContent').html($('#messageContent').html().replace(/\n/g,'<br/>'));
});
</script>
</html>