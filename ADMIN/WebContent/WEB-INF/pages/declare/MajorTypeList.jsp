                            ...
                            <div class="detail_right">
                                <div class="content_wrap">
                                    <div class="detail_right_title h1 white">
                                      <span id="ctl00_ContentPlaceHolder1_Label1" style="float: left;">专业类型列表</span></div>
                                    ...
                                    <form name="formSearch" method="post" action="MajorTypeList.do">
                                      <div class="form-group form-horizontal">
                                		...
                                		<% 	 
                                      	...
                                      	%>
										<% 
                                      		if (adminUserHelper.hasPermission(DeclareAdminResource.MAJOR_TYPE, OperationConfig.CREATE)) {
                                		%>
                                		<input type="button" value="新增" class="btn72" onclick="javascript:location.href='MajorTypeManage.do'"/>
                                		<% 	 
                                			}
                                      	%>
                                        ...
                                        <table class="gv js-gvHead" cellspacing="0" rules="all" border="1" style="border-collapse:collapse;">
                                          <tbody>
                                            ...
                                            <tr class="gv_Item">
                                              ...
                                              <td>
                                              	<% if(DeclareAdminConfig.ADMIN_LEVEL_COUNTRY.equals(bean.getMajorLevel())){
                                              	%>
                                              ...
                                              <td>
                                            <% 
                                      		if (adminUserHelper.hasPermission(DeclareAdminResource.MAJOR_TYPE, OperationConfig.UPDATE)) {
                                			%>
                                			 <a href="MajorTypeManage.do?majorId=<%=bean.getMajorId() %>" style="cursor:pointer;">编辑</a>
                                			<% 	 
                                			}
                                      		%>
                                             </td>
