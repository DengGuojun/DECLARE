...
<%
	SmsUserBean bean = (SmsUserBean)request.getAttribute("SmsUserBean");
...
<%@include file="../nav/navigation.jsp" %>
  <form name="formData" id="formData" method="post" action="SmsUserManage.do" onsubmit="javascript:return checkForm('formData');" >
			  ...
			  <div class="detail_right">
				<div class="content_wrap fixed_height">
				  <div class="detail_right_title h1 white">
				   <span id="ctl00_ContentPlaceHolder1_Label1" style="float: left;">修改联系人</span>
				  </div>
				    <div class="right_bg" style="padding-left: 5px;">
				    <input type="hidden" name="smsUserId" value="<%=bean.getSmsUserId()%> ">
        			...
        			<tbody>
        				<tr>
        					...
        					<td>
        					<input type="text" name="smsUserProvince" id="smsUserProvince"  size="20" class="form-control"  value="<%=bean.getSmsUserProvince() %>" checkStr="省份;txt;true;;100"/>
        					</td>
        				</tr>
        				<tr>
        					<td class="tit"><span style="color: #ff0000;">*</span>姓名</td>
        					<td>
        					<input type="text" name="smsUserName" id="smsUserName" size="20"  class="form-control" value="<%=bean.getSmsUserName() %>" checkStr="姓名;txt;true;;100"/>
        					</td>
        				</tr>
        				<tr>
        					<td class="tit"><span style="color: #ff0000;">*</span>单位</td>
        					<td>
        					<input type="text" id="smsUserCorporate" name="smsUserCorporate"  class="form-control" value="<%=bean.getSmsUserCorporate() %>"  checkStr="单位;txt;true;;100"/>
        					</td>
        				</tr>
        				<tr>
        					<td class="tit"><span style="color: #ff0000;">*</span>手机</td>
        					<td>
        					<input type="text" id="smsUserMobile" name="smsUserMobile"  class="form-control" value="<%=bean.getSmsUserMobile() %>" checkStr="手机;txt;true;;100"/>
        					</td>
        				</tr>
        			</tbody>
        		</table>
