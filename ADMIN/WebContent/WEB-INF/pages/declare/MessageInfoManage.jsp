...
<%
	MessageInfoBean bean = (MessageInfoBean)request.getAttribute("MessageInfo");
...
<%@include file="../nav/navigation.jsp" %>
  <form name="formData" id="formData" method="post" action="MessageInfoManage.do" onsubmit="javascript:return checkForm('formData');" >
                            ...
                            <div class="detail_right">
                            	<div class="content_wrap fixed_height">
                                    <div class="detail_right_title h1 white">
                                        <span style="float: left;">发送新邮件</span>
                                    </div>
                                    <div class="right_bg" style="padding-left: 5px;">
                                        <div style="width: 500px; margin: 0 auto;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly id="citySel" name="receiverList" onclick="showMenu();" class="form-control int_normal"  checkStr="接收者;txt;true;;10000"/>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="int_default">主题：</label>
                                                <input type="text" name="title" class="form-control int_normal"  checkStr="主题;txt;true;;100">
                                            </div>
                                            <div class="form-group">
                                                <label class="int_default">邮件内容：</label>
                                            ...
                                            <div class="text_center mt_15">
                                                <input type="submit" class="btn72 mt_5" id="confirm" value="发 送">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
function up() {
    ...
    for (var i = 0; i < file_data.length; i++) {
        ...
        $.ajax({
        		url: 'FileInfoUpload.do?infoType=<%=FileInfoConfig.INFO_TYPE_MESSAGE_ATTACH%>',
            data: fd,
            contentType: false,
            processData: false,
            type: 'POST',
