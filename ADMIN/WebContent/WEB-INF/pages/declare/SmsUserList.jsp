...
<%
	...
	List<SmsUserBean> list = (List<SmsUserBean>)request.getAttribute("SmsUserList");
%>
                            ...
                            <div class="content_wrap fixed_height">
                                 <div class="right_bg" style="padding-left: 5px;">
                                  ...
                                  <div class="form-group form-horizontal">
                                  	<label>省份：</label>
									<input type="text" name="smsUserProvince" id="smsUserProvince"  size="20" class="form-control"  checkStr="省份;txt;true;;100"/>
					  			   </div>
					  			   <div class="form-group form-horizontal">
                                  	<label>姓名：</label>
									<input type="text" name="smsUserName" id="smsUserName" size="20"  class="form-control" checkStr="姓名;txt;true;;100"/>
					  			   </div>
					  			   <div class="form-group form-horizontal">
					  			   <label>单位：</label>
                                      	<input type="text" id="smsUserCorporate" name="smsUserCorporate"  class="form-control"  checkStr="单位;txt;true;;100"/>
                                    </div>
                                     <div class="form-group form-horizontal">
					  			   <label>手机：</label>
                                      	<input type="text" id="smsUserMobile" name="smsUserMobile"  class="form-control"  checkStr="手机;txt;true;;100"/>
                                    </div>
					  			<input type="submit" value="添加联系人" class="btn72" />
					  			</form>
                                  <div>
