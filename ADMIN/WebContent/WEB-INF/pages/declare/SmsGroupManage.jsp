...
<%
	SmsGroupBean bean = (SmsGroupBean)request.getAttribute("SmsGroupBean");
...
<%@include file="../nav/navigation.jsp" %>
  <form name="formData" id="formData" method="post" action="SmsGroupManage.do" onsubmit="javascript:return checkForm('formData');" >
