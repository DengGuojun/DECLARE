                        ...
                        <td valign="top">
                            <div class="detail_right">
                            	<div class="content_wrap fixed_height">
                            		...
                            		<span id="ctl00_ContentPlaceHolder1_Label1" style="float: left;">培育对象统计</span>
                            		</div>
                            		<div class="con fl pt_10">
                            			<ul id="tags" class="tags" style="width: 1100px;">
                            				...
                            				<li>
                            				<%} %> 
                            					<a class="text_15" href="DeclareStatisticsList.do">各地申报情况统计</a>
                            				</li>
                            				...
                            				<li>
                            				<%} %>
                            					<a class="text_15" href="DeclareStatisticsList.do?declareType=<%=DeclareInfoConfig.DECLARE_TYPE_YOUNG_FARMER %>">现代青年农场主</a>
                            				</li>
                            				...
                            				<li>
                            				<%} %>
                                                <a class="text_15" href="DeclareStatisticsList.do?declareType=<%=DeclareInfoConfig.DECLARE_TYPE_LEADER_FARMER %>">新型农业经营主体带头人培训</a>
                                            </li>
                            				...
                            				<li>
                            				<%} %>
                                                <a class="text_15" href="DeclareStatisticsList.do?declareType=<%=DeclareInfoConfig.DECLARE_TYPE_PRODUCT_FARMER %>">生产经营型职业农民培训</a>
                                            </li>
                                           <%if(declareType == DeclareInfoConfig.DECLARE_TYPE_TECHNICAL_FARMER){ %>
                            				...
                            				<li>
                            				<%} %>
                                                <a class="text_15" href="DeclareStatisticsList.do?declareType=<%=DeclareInfoConfig.DECLARE_TYPE_TECHNICAL_FARMER %>">专业技能型职业农民培训</a>
                                            </li>
                            			...
                            			<div id="tagContent">
                            				<div class="tagContent selectTag scroller-box">
                            					...
                            					<form name="formSearch" method="post" action="DeclareStatisticsList.do">
                            							...
                            							<table class="gv js-gvHead" cellspacing="0" rules="all" border="1" style="border-collapse:collapse;">
                            								<tbody>
                            									...
                            									<% if(declareType == 0){ %>
                            										...
                            										<th rowspan="2">地区</th>
                            										<th rowspan="2">总数</th>
                            										<th colspan="4">现代青年农场主培训</th>
                            										<th colspan="4">新型农业经营主体带头人培训</th>
                            										<th colspan="4">生产经营型职业农民培训</th>
                            										<th colspan="4">专业技能型职业农民培训</th>
                            										<th colspan="4">专业服务型职业农民培训</th>
                            									</tr>
                                                                <tr class="gv_Head">
                                                                    <th>申报人数</th>
                                                                    <th>审核通过</th>
