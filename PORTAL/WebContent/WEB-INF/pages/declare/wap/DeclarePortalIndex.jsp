	...
	<div class="placeHolder"></div>
	  ...
	  <section class="info-table mb-55">
       <ul>
	      ...
	      <dt><input maxlength="20" placeholder="手机号码" type="number" name="userMobile" id="userMobile"  readonly value="<%=userMobile %>" /></dt>
	      </li>
          <li>
           ...
           <li>
               ...
               <dt><input maxlength="25" placeholder="产业规模" type="number" id="industrySize1" name="industrySize1" value="<%=declareReportBean.getIndustryScale1() > 0 ? declareReportBean.getIndustryScale1() : "" %>"/></dt>
           </li>
           <li id="breed">
