...
<div class="g-wrap g-pb0">
    ...
    <div style="margin-bottom:60px">
        ...
        <section class="g-mb10 bg-df9">
            <article class="g-font-color course-detailContent">
                <%=DateKit.formatTimestamp(classInfoBean.getRegistrationEndTime(), DateKit.DEFAULT_DATE_TIME_FORMAT) %>
            </article>
        </section>
        <div class="left-h2">培训开始时间</div>
        <section class="g-mb10 bg-df9">
            <article class="g-font-color course-detailContent">
                <%=DateKit.formatTimestamp(classInfoBean.getTrainingBeginTime(), DateKit.DEFAULT_DATE_TIME_FORMAT) %>
            </article>
        </section>
        <div class="left-h2">培训结束时间</div>
        <section class="g-mb10 bg-df9">
            <article class="g-font-color course-detailContent">
                <%=DateKit.formatTimestamp(classInfoBean.getTrainingEndTime(), DateKit.DEFAULT_DATE_TIME_FORMAT) %>
            </article>
        </section>
    </div>
</div>
