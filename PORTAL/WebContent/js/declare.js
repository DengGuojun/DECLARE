...
function setAjax(id,elm,callback){
        if(id == 'province'){
            $.ajax({
                type: 'POST',
                dataType:'jsonp',
                url: 'http://ims.ngonline.cn/m/ProvinceList.action?jsoncallback='+callback,
            ...
            $.ajax({
                type: 'POST',
                dataType:'jsonp',
                url: "http://ims.ngonline.cn/m/CityList.action?provinceId="+provinceId+"&jsoncallback="+callback,
                success: function(data){
                },
                error: function(){
                    return;
            ...
            $.ajax({
                type: 'POST',
                dataType:'jsonp',
                url: "http://ims.ngonline.cn/m/RegionList.action?cityId="+cityId+"&jsoncallback="+callback,
                success: function(data){
                },
                error: function(){
                    return;
