...
te$.stringToJson = function (t) {
    ...
    switch (t) {
        ...
        case"addressProvince":
            e = "http://ims.ngonline.cn/m/ProvinceList.action";
            break;
        case"addressCity":
            e = "http://ims.ngonline.cn/m/CityList.action";
            break;
        case"addressRegion":
            e = "http://ims.ngonline.cn/m/RegionList.action"
            break;
        case"couponVerify":
...
_bigSlide.prototype.start = function () {
    ...
    var n = {}, s = {}, a = {}, r = {}, c = null, l = null, d = null, u = {
        province: [e.getUrl("addressProvince"), "countryId"],
        city: [e.getUrl("addressCity"), "provinceId"],
        region: [e.getUrl("addressRegion"), "cityId"]
        ...
        for (var l = 0, d = s.length; d > l; l++)s[l].onclick = function (o) {
            ...
            i(this).addClass("selected"), r[t] && (r[t].value = this.getAttribute("data-value"), "province" == t && (b("city", this.getAttribute("data-id"), n), r.city.value = "", r.region.value = "", a.province.style.display = "none", a.city.style.display = "block", a.region.style.display = "none", a.region.innerHTML = ""), "city" == t && (b("region", this.getAttribute("data-id"), n), r.region.value = "", a.province.style.display = "none", a.city.style.display = "none", a.region.style.display = "block"), "region" == t && (p.style.display = "none"), c.value = r.province.value + r.city.value + r.region.value, v(t))
        }
    }, b = function (t, e, o) {
        var n = {};
        if (m) {
