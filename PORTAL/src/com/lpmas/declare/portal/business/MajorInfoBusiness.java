...
import com.lpmas.declare.portal.dao.MajorInfoDao;
...
public class MajorInfoBusiness {
	...
	public boolean isExistsMajorInfoName(MajorInfoBean bean) {
		MajorInfoBean existsBean = getMajorInfoByNameAndStatus(bean.getMajorName(), bean.getTypeId());
		if (existsBean == null) {
			return false;
		} else {
	...
	public MajorInfoBean getMajorInfoByNameAndStatus(String majorName, int typeId) {
		MajorInfoDao dao = new MajorInfoDao();
		return dao.getMajorInfoByNameAndStatus(majorName, typeId);
	}
