...
import com.lpmas.declare.portal.config.FormInstructionConfig;
...
public class FormInstructionDisplay extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 转发
		PortalKit.forwardPage(request, response, DeclarePortalConfig.PAGE_PATH + "FormInstructionDisplay.jsp");
	}
