...
import com.lpmas.declare.portal.business.TeacherMajorInfoBusiness;
 ...
 */
@WebServlet("/declare/TeacherMajorInfoJsonList.do")
public class TeacherMajorInfoJsonList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		List<TeacherMajorInfoBean> list = business.getTeacherMajorInfoListByTypeId(typeId);
		if (list.size() > 0) {
