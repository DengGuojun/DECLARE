...
import com.lpmas.declare.portal.config.DeclareImagePortalConfig;
...
public class DeclareImageManage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 转发
		PortalKit.forwardPage(request, response, DeclarePortalConfig.PAGE_PATH + "DeclareImageManage.jsp");
