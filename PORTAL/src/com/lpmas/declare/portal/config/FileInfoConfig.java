...
public class FileInfoConfig {
	...
	// 设置文件保存路径
	public static final String ADMIN_FILE_PATH = PropertiesKit.getBundleProperties(DeclarePortalConfig.DECLARE_PROP_FILE_NAME,
			"ADMIN_FILE_PATH");
	// 设置文件备份路径
	public static final String ADMIN_BACKUP_FILE_PATH = PropertiesKit
			.getBundleProperties(DeclarePortalConfig.DECLARE_PROP_FILE_NAME, "ADMIN_BACKUP_FILE_PATH");
