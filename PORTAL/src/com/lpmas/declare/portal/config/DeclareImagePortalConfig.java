...
public class DeclareImagePortalConfig {
	...
	public static final String TEMP_FILE_PATH = PropertiesKit
			.getBundleProperties(DeclarePortalConfig.DECLARE_PROP_FILE_NAME, "TEMP_FILE_PATH");
	...
	// 默认删除
	static {
		String isDeleteTempFileStr = PropertiesKit.getBundleProperties(DeclarePortalConfig.DECLARE_PROP_FILE_NAME,
				"IS_DELETE_TEMP_FILE");
